...
- The episodes before your first recorded scrobble and after your last one might be filled a bit sporadically. I recommend manually marking your first and last watched episodes, then use gap mode to automatically fill any missing episodes between them.
